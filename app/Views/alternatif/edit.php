...
<div class="create">
    <form action="<?= base_url('alternatif/' . $alternatif['id'] . '/update') ?>" method="POST">
        <?= csrf_field() ?>
        <input type="hidden" name="_method" value="PUT">

        <div class="form-input">
            <label for="simluhtan">simluhtan</label>
            <input type="number" id="simluhtan" name="simluhtan" class="form-control" placeholder="nama kelompok" value="<?= $alternatif['simluhtan'] ?>">
        </div>
        <div class="form-input">
        ...
        <div class="form-input">
            ...
            <input type="number" id="nomor_hp" name="nomor_hp" class="form-control" placeholder="nomor hp" value="<?= $alternatif['nomor_hp'] ?>">
        </div>
        <div class="form-input">
